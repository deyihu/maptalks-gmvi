...
function  canvasTest() {
    // var coors=[[120.45678999738529,31.27636320912866],[120.57275726811345,31.32909779960715],
    // [120.70166404483864,31.32738880824905],[120.74878337799765,31.274410076147976]]
    var data = [];
    var fromObj=dataConst[2];
    var fromName=fromObj.name;
    var fromCoor=geoCoordMap[fromName];
    for(var i=0;i<dataConst.length;i++){
        if(i==2||data.length>10) continue;
